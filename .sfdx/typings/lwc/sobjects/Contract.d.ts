...
declare module "@salesforce/schema/Contract.Parent_Contract__c" {
  const Parent_Contract__c:any;
  export default Parent_Contract__c;
}
declare module "@salesforce/schema/Contract.Parent_Contract__r" {
  const Parent_Contract__r:any;
  export default Parent_Contract__r;
}
