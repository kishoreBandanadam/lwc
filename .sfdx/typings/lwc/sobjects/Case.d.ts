...
declare module "@salesforce/schema/Case.User__c" {
  const User__c:any;
  export default User__c;
}
declare module "@salesforce/schema/Case.User__r" {
  const User__r:any;
  export default User__r;
}
declare module "@salesforce/schema/Case.email3__c" {
  const email3__c:string;
  export default email3__c;
}
declare module "@salesforce/schema/Case.text__c" {
