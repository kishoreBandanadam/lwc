declare module "@salesforce/schema/AccountChangeEvent.AccountAmount__c" {
  const AccountAmount__c:number;
  export default AccountAmount__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Contact_Roll_Up_Summary__c" {
  const Contact_Roll_Up_Summary__c:number;
  export default Contact_Roll_Up_Summary__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.No_of_Expenses__c" {
  const No_of_Expenses__c:number;
  export default No_of_Expenses__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Number_of_Trucks__c" {
  const Number_of_Trucks__c:number;
  export default Number_of_Trucks__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Out_of_Zip__c" {
  const Out_of_Zip__c:boolean;
  export default Out_of_Zip__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Revenue__c" {
...
declare module "@salesforce/schema/AccountChangeEvent.Status1__c" {
